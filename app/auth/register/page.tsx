          ...
          <div className="glass-card rounded-2xl p-8 border border-[rgba(74,69,77,0.2)]">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button className="flex items-center justify-center gap-2 h-11 rounded-xl border border-[rgba(74,69,77,0.3)] text-sm font-medium text-on-surface hover:bg-white/[0.04] transition-all active:scale-[0.98]">
